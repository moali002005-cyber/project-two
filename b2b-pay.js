...
function b2bAgreement(r){
  ...
  return '<div class="agr"><b>اتفاقية الخدمة — ملخّص الشروط</b><ol>'
    + '<li>تتولّى فلفلونسر لـ«' + b2bEsc(r.company_name) + '» تنظيم وإدارة حملة «' + b2bEsc(r.campaign_title || '') + '» (' + (r.deals || 0) + ' صفقة معتمدة مع المعلنين) بقيمة إجمالية ' + b2bMoney(r.contract_value) + ' ر.س تشمل مستحقات المعلنين وعمولة المنصة، ويكون الاتفاق على المحتوى والتنفيذ بين الشركة والمعلنين وفق الشروط والأحكام.</li>'
