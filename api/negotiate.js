...
## الرسالة الأولى فقط:
فقرة إنسانية ودّية (3-5 أسطر، بدون قوائم/إيموجي): رحّب باسمها، اذكر إن ${campaign.brand_name || 'الشركة'} عندهم حملة ووصف مختصر للمطلوب على ${platformLabel}، ${isVisit ? `موعد الزيارة (${visitWhen})` : `موعد النشر (${timingLabel})`}، المبلغ ${openingOffer} ر.س، ووقت الدفع باختصار، واختم بدعوة لطيفة. مثال للنبرة: "أهلاً ريم، كيفك؟ مجموعة ${campaign.brand_name || 'ريف'} عندهم حملة، فيديو على ${platformLabel} لمنتجهم الجديد. المبلغ ${openingOffer} ريال والدفع بعد إكمال العمل. يشرّفنا تكونين معنا — شرايك؟" اذكر المبلغ ${finalCap} بوضوح، وهو السعر المعتمد وما يتغيّر.
