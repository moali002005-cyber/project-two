...
## الرسالة الأولى فقط:
سطران كحد أقصى (بدون قوائم/إيموجي): تحية باسمها، المطلوب باختصار على ${platformLabel}، ${isVisit ? `موعد الزيارة (${visitWhen})` : `موعد النشر (${timingLabel})`}، والمبلغ ${finalCap} ر.س، ثم دعوة قصيرة. مثال: "أهلاً ريم، معك وكيل ${campaign.brand_name || 'ريف'}. عندنا فيديو على ${platformLabel} ${isVisit ? `وموعد الزيارة ${visitWhen}` : `والنشر ${timingLabel}`}، والمبلغ ${finalCap} ريال. شرايك؟" لا تزيد على هذا.
